        ...
        <div class="replenishment-container">
          <div>
            ...
            <div class="replenishment-sum">
              ...
              <div class="replenishment-calc">
                ...
                <div class="transfer-cont">
                  ...
                  />
                  <input type="text" class="calc-value" placeholder="0.0000000">
                </div>
            ...
            <button 
              ...
              class="replenishment-button">Пополнить баланс
            </button>
            <div 
              v-if="isUpBalance"
              class="info-box">
          ...
          <div>
            ...
            <div 
              ...
              class="transfer-item"
              :class="{'transfer-item-select' : selectTranslations == item.value}">
          ...
          >
            <div class="payment-information-container">
              ...
              <div class="payment-information-container-history">
                <a href="/TransactionHistory" class="transaction-history">История транзакций</a>
            ...
            <div class="payment-information-container">
              ...
              <div class="payment-information-email">
                ...
                <div class="payment-status">
                  ...
                  <span class="payment-status-text"> {{waitTranslationsText}}</span>
            ...
            <div class="payment-information-container">
              ...
              <button 
                v-on:click="onPaid()"
                :class="{'pay-button-submit_state' : isPaid, 'pay-button-submit' : !isPaid}"
                > 
                  {{paidButtonText}}
              </button>
            </div>
        ...
        <div  
          ...
          class="payment-information">
            <div class="payment-information-container">
              ...
              <div class="payment-information-container-history">
                <a class="transaction-history">История транзакций</a>
                <span class="time">08.07.2019 18:16</span>
              </div>
            </div>
            <div
...
export default {
  ...
  methods: {
    ...
    onPaid: function() {
      ...
      this.waitTranslationsText = !this.isPaid ? "Ожидание оплаты" : "Обрабатываеться"
    }
  }
};
</script>
...
<style lang="scss">
  @import '~assets/styles/BalanceReplenishment/styles.scss';
</style>